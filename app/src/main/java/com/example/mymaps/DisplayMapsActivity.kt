...
//        mMap.moveCamera(CameraUpdateFactory.newLatLngBounds(boundsBuilder.build(),300,300,0))
        mMap.animateCamera(CameraUpdateFactory.newLatLngBounds(boundsBuilder.build(),300,300,0))
    }
}